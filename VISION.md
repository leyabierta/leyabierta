...
Lee [CONTRIBUTING.md](CONTRIBUTING.md) para los detalles técnicos y [GOVERNANCE.md](GOVERNANCE.md) para entender cómo se toman las decisiones.

---

*Este documento es la referencia para evaluar si una contribución o decisión está alineada con el proyecto. Ante la duda, vuelve aquí.*
